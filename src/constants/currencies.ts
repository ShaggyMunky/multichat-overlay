import { CurrencyType } from "../types/currencyTypes.js";
...
export const CURRENCIES: CurrencyType[] = [
  ...
  { code: "BYR", description: "Belarusian Ruble" },
  ...
  { code: "EEK", description: "Estonian Kroon" },
  ...
  { code: "LTL", description: "Lithuanian Litas" },
  { code: "LVL", description: "Latvian Lats" },
  ...
  { code: "MRO", description: "Mauritanian Ouguiya" },
  ...
  { code: "ZMK", description: "Zambian Kwacha (pre-2013)" },
